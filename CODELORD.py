...
{K}[{P}•{K}]{P}——————————————————————————————
{H}[{P}>{K}]{P} AUTHOR➣➣➣➣GHOSTON🎭
{H}[{P}>{K}]{P} WHATSAPP➣➣➣2349138017570
{H}[{P}>{K}]{P} INSTAGRA➣➣➣Iam Ghostwizard🎭
{H}[{P}>{K}]{P} GITHUB➣➣➣➣Ghostson🎭
{H}[{P}>{K}]{P} VERSION➣➣➣➣50.0
{H}[{P}>{K}]{P} TOOLNAME➣➣➣➣CODELORD🎭
{K}[{P}•{K}]{P}——————————————————————————————
""")
def xoshnaw(): 
